//GUI Spyfall in Java, uses Locations.dat and Spyfall Settings.dat
...
public class Spyfall extends Application {
	...
	static String[] locationNames = new String[100];
	static String[][] roles = new String [100][8];
	static int numPlayers;
	static String playerRoles[] = new String[8];
	static int currentLocation;

	TextField[] names = new TextField[8];
	CheckBox chkRoles = new CheckBox("Roles");
	...
	public void start(Stage primaryStage) {
		...
		Scene scene = new Scene(pane, 370, 320);
	...
	public void seeLocation(int index, Button name) {
		if (isStarted) {
			...
			//newStage.getIcons().add(new Image("icon.jpg"));
			newStage.setTitle("");
			newStage.show();
